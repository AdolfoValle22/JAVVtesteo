...
namespace JAVV.Temperatura.Tests
{
    ...
    public class TemperatureConverterTests
    {
        ...
        [TestMethod] // Atributo requerido por MSTest para identificar un método de prueba
        ...
        public void CelsiusToFahrenheit_Zero_ReturnsThirtyTwo()
        {
            ...
            // Assert (Aserción - Comprobación)
            // Usa AreEqual para comparar valores de coma flotante, especificando la tolerancia (delta)
